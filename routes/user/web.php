...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
    ...
    Route::middleware('complete.kyc')->group(function () {
        ...
        //Tax code
         ...
         Route::get('taxverification', [ViewsController::class, 'taxverification'])->name('taxverification');
          Route::post('taxverification', [WithdrawalController::class, 'taxverification'])->name('taxverification');
