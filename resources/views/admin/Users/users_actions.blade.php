...
<!-- send a single user email Modal-->
 <div id="userTax" class="modal fade" role="dialog">
    <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Enter {{ $user->name }} {{ $user->l_name }} tax code </h4>
                 <button type="button" class="close " data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('usertax') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" name="taxcode" class="form-control" value="{{ $user->taxcode }}">
                     </div>
                     ...
                     @csrf
                      <div class="form-group">
                         ...
                         <select class="form-control  " name="withdrawal_code">
                             <option value="" selected disabled>Current Status:  {{ $user->withdrawal_code
 }} </option>
