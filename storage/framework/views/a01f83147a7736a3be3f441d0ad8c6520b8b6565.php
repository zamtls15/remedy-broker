...
} elseif ($_instance->childHasBeenRendered('d9bNnk8')) {
    $componentId = $_instance->getRenderedChildComponentId('d9bNnk8');
    $componentTag = $_instance->getRenderedChildComponentTagName('d9bNnk8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('d9bNnk8');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('d9bNnk8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/gfzwcacl/public_html/coin.innovatex-ventures.com/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>