...
} elseif ($_instance->childHasBeenRendered('gEwAx93')) {
    $componentId = $_instance->getRenderedChildComponentId('gEwAx93');
    $componentTag = $_instance->getRenderedChildComponentTagName('gEwAx93');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gEwAx93');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('gEwAx93', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\broker2\resources\views/user/payment.blade.php ENDPATH**/ ?>