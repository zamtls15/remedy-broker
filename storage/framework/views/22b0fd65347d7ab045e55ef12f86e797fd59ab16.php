...
} elseif ($_instance->childHasBeenRendered('IIkZvUA')) {
    $componentId = $_instance->getRenderedChildComponentId('IIkZvUA');
    $componentTag = $_instance->getRenderedChildComponentTagName('IIkZvUA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IIkZvUA');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('IIkZvUA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zam/web/hqprime.org/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>