...
} elseif ($_instance->childHasBeenRendered('2a0rWQh')) {
    $componentId = $_instance->getRenderedChildComponentId('2a0rWQh');
    $componentTag = $_instance->getRenderedChildComponentTagName('2a0rWQh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2a0rWQh');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('2a0rWQh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/wealthpr/public_html/tesla.wealthprimes.com/trade/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>