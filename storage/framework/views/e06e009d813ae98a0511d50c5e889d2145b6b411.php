...
} elseif ($_instance->childHasBeenRendered('8ny55Ma')) {
    $componentId = $_instance->getRenderedChildComponentId('8ny55Ma');
    $componentTag = $_instance->getRenderedChildComponentTagName('8ny55Ma');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8ny55Ma');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('8ny55Ma', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vkhpudlm/pro.simplemarkcoin.net/resources/views/user/withdraw.blade.php ENDPATH**/ ?>