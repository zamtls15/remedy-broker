...
} elseif ($_instance->childHasBeenRendered('JD4s20c')) {
    $componentId = $_instance->getRenderedChildComponentId('JD4s20c');
    $componentTag = $_instance->getRenderedChildComponentTagName('JD4s20c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JD4s20c');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('JD4s20c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/demo4.remedycodes.com.ng/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>