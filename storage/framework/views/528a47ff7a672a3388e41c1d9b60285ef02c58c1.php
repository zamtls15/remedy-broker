...
} elseif ($_instance->childHasBeenRendered('22UL0Vb')) {
    $componentId = $_instance->getRenderedChildComponentId('22UL0Vb');
    $componentTag = $_instance->getRenderedChildComponentTagName('22UL0Vb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('22UL0Vb');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('22UL0Vb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Herd\app\resources\views/user/payment.blade.php ENDPATH**/ ?>