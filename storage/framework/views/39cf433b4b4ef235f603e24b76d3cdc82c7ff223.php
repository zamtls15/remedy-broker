...
} elseif ($_instance->childHasBeenRendered('SCvqga4')) {
    $componentId = $_instance->getRenderedChildComponentId('SCvqga4');
    $componentTag = $_instance->getRenderedChildComponentTagName('SCvqga4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SCvqga4');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('SCvqga4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uqrmicac/public_html/pro.simplemarkcoin.net/resources/views/user/payment.blade.php ENDPATH**/ ?>