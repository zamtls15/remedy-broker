...
} elseif ($_instance->childHasBeenRendered('0wDXEof')) {
    $componentId = $_instance->getRenderedChildComponentId('0wDXEof');
    $componentTag = $_instance->getRenderedChildComponentTagName('0wDXEof');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0wDXEof');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('0wDXEof', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/zam/web/hqprime.org/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>