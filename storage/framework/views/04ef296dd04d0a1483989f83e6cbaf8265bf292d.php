...
} elseif ($_instance->childHasBeenRendered('s57DKee')) {
    $componentId = $_instance->getRenderedChildComponentId('s57DKee');
    $componentTag = $_instance->getRenderedChildComponentTagName('s57DKee');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s57DKee');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('s57DKee', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/uqrmicac/public_html/pro.simplemarkcoin.net/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>