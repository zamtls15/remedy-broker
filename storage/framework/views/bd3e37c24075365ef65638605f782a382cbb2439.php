...
} elseif ($_instance->childHasBeenRendered('GKrzbVr')) {
    $componentId = $_instance->getRenderedChildComponentId('GKrzbVr');
    $componentTag = $_instance->getRenderedChildComponentTagName('GKrzbVr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GKrzbVr');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('GKrzbVr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gfzwcacl/public_html/coin.innovatex-ventures.com/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>