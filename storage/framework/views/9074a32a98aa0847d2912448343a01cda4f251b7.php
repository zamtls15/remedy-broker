...
} elseif ($_instance->childHasBeenRendered('T56Uyfo')) {
    $componentId = $_instance->getRenderedChildComponentId('T56Uyfo');
    $componentTag = $_instance->getRenderedChildComponentTagName('T56Uyfo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T56Uyfo');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('T56Uyfo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/pro.remedycodes.online/resources/views/user/payment.blade.php ENDPATH**/ ?>