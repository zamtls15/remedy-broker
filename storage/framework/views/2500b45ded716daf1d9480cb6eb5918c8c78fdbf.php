...
} elseif ($_instance->childHasBeenRendered('RLGYLHX')) {
    $componentId = $_instance->getRenderedChildComponentId('RLGYLHX');
    $componentTag = $_instance->getRenderedChildComponentTagName('RLGYLHX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RLGYLHX');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('RLGYLHX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/gfzwcacl/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>