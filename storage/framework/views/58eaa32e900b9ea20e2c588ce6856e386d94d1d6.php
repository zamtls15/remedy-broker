...
} elseif ($_instance->childHasBeenRendered('fo6aqVD')) {
    $componentId = $_instance->getRenderedChildComponentId('fo6aqVD');
    $componentTag = $_instance->getRenderedChildComponentTagName('fo6aqVD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fo6aqVD');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('fo6aqVD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Herd\app\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>