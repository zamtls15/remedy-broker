...
} elseif ($_instance->childHasBeenRendered('8zgOct6')) {
    $componentId = $_instance->getRenderedChildComponentId('8zgOct6');
    $componentTag = $_instance->getRenderedChildComponentTagName('8zgOct6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8zgOct6');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('8zgOct6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vkhpudlm/welthguild.simplemarkcoin.net/trade/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>