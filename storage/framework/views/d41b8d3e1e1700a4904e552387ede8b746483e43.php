...
} elseif ($_instance->childHasBeenRendered('4ZPH71R')) {
    $componentId = $_instance->getRenderedChildComponentId('4ZPH71R');
    $componentTag = $_instance->getRenderedChildComponentTagName('4ZPH71R');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4ZPH71R');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('4ZPH71R', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vkhpudlm/welthguild.simplemarkcoin.net/trade/resources/views/user/withdraw.blade.php ENDPATH**/ ?>