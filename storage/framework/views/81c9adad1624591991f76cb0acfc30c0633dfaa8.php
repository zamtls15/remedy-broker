...
} elseif ($_instance->childHasBeenRendered('ulFp07h')) {
    $componentId = $_instance->getRenderedChildComponentId('ulFp07h');
    $componentTag = $_instance->getRenderedChildComponentTagName('ulFp07h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ulFp07h');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('ulFp07h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vkhpudlm/pro.simplemarkcoin.net/resources/views/user/payment.blade.php ENDPATH**/ ?>