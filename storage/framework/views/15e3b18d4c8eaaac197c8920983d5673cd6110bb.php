            ...
            <div class="collapse navbar-collapse" id="sidenavCollapse">
                ...
                <ul class="navbar-nav mb-lg-7">
                    ...
                    <?php if($mod['subscription']): ?>
                        <li class="nav-item">
                            <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['nav-link', 'active' => request()->routeIs('subtrade')]) ?>" href="<?php echo e(route('subtrade')); ?>">
        ...
        <footer class="mt-auto">
            <div class="container-fluid mt-4 mb-6 text-muted">
                <div class="row justify-content-between">
                    <div class="col">
                        All Rights Reserved &copy; <?php echo e($settings->site_name); ?> <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\xampp\htdocs\onlinetrader\resources\views/layouts/dashly1.blade.php ENDPATH**/ ?>