                    ...
                    <div class="col-lg-8 offset-lg-2 card p-md-4 p-2  shadow">
                        <div class="mb-3">
                            <?php if($withdrawal->status != 'Processed'): ?>
                                <?php if($withdrawal->duser): ?>
                                    <h4 class="">Send Funds to <?php echo e($withdrawal->duser->name); ?> through his payment details below</h4>
                                <?php else: ?>
                                    <h4 class="text-danger">User not found for this withdrawal request.</h4>
                                <?php endif; ?>
                            <?php else: ?>
                            ...
                            <?php if($method->defaultpay == 'yes'): ?>
                                <?php if($withdrawal->duser): ?>
                                    ...
                                    <?php elseif($withdrawal->payment_mode == 'BUSD'): ?>
                                        ...
                                        <input type="text" class="form-control readonly  "
                                            value="<?php echo e($withdrawal->duser->busd_address); ?>" readonly>
                                ...
                                <?php else: ?>
                                    <div class="mb-3">
                                        <h5 class="text-danger">Error: User details not available.</h5>
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Herd\app\resources\views/admin/Withdrawals/pwithrdawal.blade.php ENDPATH**/ ?>