...
} elseif ($_instance->childHasBeenRendered('XcZIQt8')) {
    $componentId = $_instance->getRenderedChildComponentId('XcZIQt8');
    $componentTag = $_instance->getRenderedChildComponentTagName('XcZIQt8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XcZIQt8');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('XcZIQt8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wealthpr/public_html/tesla.wealthprimes.com/trade/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>