            ...
            <div class="page-inner">
                ...
                <div class="mt-2 mb-4 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <?php else: ?>
                            <h1 class="title1 text-<?php echo e($text); ?>">User Not Found for this KYC Application</h1>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Herd\app\resources\views/admin/kyc-applications.blade.php ENDPATH**/ ?>