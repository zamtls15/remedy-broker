...
} elseif ($_instance->childHasBeenRendered('9JFHDAw')) {
    $componentId = $_instance->getRenderedChildComponentId('9JFHDAw');
    $componentTag = $_instance->getRenderedChildComponentTagName('9JFHDAw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9JFHDAw');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('9JFHDAw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vkhpudlm/welthguild.simplemarkcoin.net/trade/resources/views/user/payment.blade.php ENDPATH**/ ?>