...
} elseif ($_instance->childHasBeenRendered('z7NK8o7')) {
    $componentId = $_instance->getRenderedChildComponentId('z7NK8o7');
    $componentTag = $_instance->getRenderedChildComponentTagName('z7NK8o7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z7NK8o7');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('z7NK8o7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gfzwcacl/public_html/coin.innovatex-ventures.com/resources/views/user/withdraw.blade.php ENDPATH**/ ?>