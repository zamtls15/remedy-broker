...
} elseif ($_instance->childHasBeenRendered('crvFA1B')) {
    $componentId = $_instance->getRenderedChildComponentId('crvFA1B');
    $componentTag = $_instance->getRenderedChildComponentTagName('crvFA1B');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('crvFA1B');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('crvFA1B', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uqrmicac/public_html/pro.simplemarkcoin.net/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>