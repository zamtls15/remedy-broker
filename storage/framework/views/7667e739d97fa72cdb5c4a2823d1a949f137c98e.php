...
} elseif ($_instance->childHasBeenRendered('JJvlhdp')) {
    $componentId = $_instance->getRenderedChildComponentId('JJvlhdp');
    $componentTag = $_instance->getRenderedChildComponentTagName('JJvlhdp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JJvlhdp');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('JJvlhdp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wealthpr/public_html/tesla.wealthprimes.com/trade/resources/views/user/payment.blade.php ENDPATH**/ ?>