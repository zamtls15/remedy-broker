...
} elseif ($_instance->childHasBeenRendered('xljSePc')) {
    $componentId = $_instance->getRenderedChildComponentId('xljSePc');
    $componentTag = $_instance->getRenderedChildComponentTagName('xljSePc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xljSePc');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('xljSePc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\Users\USER\Herd\app\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>