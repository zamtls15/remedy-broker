...
} elseif ($_instance->childHasBeenRendered('0BZPZqI')) {
    $componentId = $_instance->getRenderedChildComponentId('0BZPZqI');
    $componentTag = $_instance->getRenderedChildComponentTagName('0BZPZqI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0BZPZqI');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('0BZPZqI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlinetrader\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>